 ...
 * 
 *     Important to note here that all Service classes (com.fleetrental.business.services.*)
 *     implement IService interface.
 *     
 *     Hence, the getService method when done, instead of returning ILoginService 
 *     or IRegistrationService it returns a IService interface class which continues the decoupling
 *     theme of MVC so the calling classes don't deal with a concrete implementation
...
public class ServiceFactory {
	...
	private String getImplName (String serviceName) throws Exception
	{
	    ...
	    //TODO: Hard coding path of the file is restrictive because if the file is renamed or
	    ...
	    java.io.FileInputStream fis = new 
			    java.io.FileInputStream("C:\\EDrive\\Regis\\MSCS670\\NewCourse\\NewCourseSoftwareInstall\\ganymede\\eclipse_workspace\\FleetRental_Week4\\config\\application.properties");
        */
